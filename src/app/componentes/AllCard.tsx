...
export default function OurProduct() {
  ...
  return (
    <div className="px-4 sm:px-8 md:px-16 lg:px-24 py-8 mt-28">
      <div>
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-center">Our Product</h1>
            ...
            <div key={i} className="flex flex-col items-center bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              ...
              <div className="flex justify-between w-full px-4 py-2">
                <div className="flex flex-col items-start">
                  <h2 className="font-medium text-base sm:text-lg md:text-xl mb-1">Library Stone Chair</h2>
